      ...
      <div class="container">
        ...
        <div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="{{Request::segment(1) === 'teachers' ? 'active' : null }}">
              <a href="{{ route('teachers') }}">Teachers</a>
            </li>
            <li class="{{Request::segment(1) === 'events' ? 'active' : null }}">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="{{Request::segment(1) === 'courses-single' ? 'active' : null }}">
                  <a href="{{ route('courses-single') }}">Course Single</a>
                </li>
